...
// Floating video card data — simulated generated videos
const FLOATERS = [
    {
        id: 1,
        platform: "TIKTOK",
                ...
                <div className="flex flex-col gap-3 w-full max-w-xs">
                    {[
                        ...
                        <div key={label} className="flex items-center gap-3">
                            <span className="text-[9px] w-6 text-right shrink-0" style={{ color }}>
                                {label}
                            </span>
                            <div
                    ...
                    <div className="flex justify-center gap-2 mt-3">
                        {MESSAGES.map((_, i) => (
                            <div
                                ...
                                style={{
                                    background: i === msgIdx ? "#92cc41" : "transparent",
                                    borderColor: i === msgIdx ? "#92cc41" : "#333",
