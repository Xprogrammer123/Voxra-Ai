...
const PHASE_MESSAGES: Record<string, string[]> = {
    footage:   [
        ...
        "AI neurons firing at full power...",
                        ...
                        {isDone && videoUrl ? (
                            ...
                            <div className="flex flex-col items-center gap-4 relative z-10">
                                ...
                                <div className="text-5xl font-black relative z-10"
                                    style={{ color: "#f7d51d", textShadow: "0 0 20px rgba(247,213,29,0.6)", fontFamily: "monospace" }}>
                ...
                <div className="flex-1 w-full">
                    {!isDone && !isFailed ? (
                        <div className="flex flex-col gap-6 p-6"
                            ...
                            {/* Phase steps */}
                            <div className="flex flex-col gap-2">
                                {["footage", "subtitles", "assembly", "done"].map((p) => {
                                    ...
                                    return (
                                        <div key={p} className="flex items-center gap-3">
                                            <div className="w-4 h-4 shrink-0 flex items-center justify-center text-[8px] font-black"
                                                style={{
                        ...
                        <div className="flex flex-col gap-6 p-6"
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-sm font-black tracking-widest" style={{ color: "#92cc41" }}>QUEST COMPLETE</span>
                            </div>

                            <PixelBar pct={100} color="#92cc41" />

                            <p className="text-xs leading-relaxed" style={{ color: "#888" }}>
                                Your video has been forged. Review the preview on the left before exporting.
                            </p>
                            ...
                            <div style={{ borderTop: "2px solid #1a2e00" }} className="pt-4 flex flex-col gap-3">
                                {/* Pass taskId as videoId so export page can link back */}
                                <Link href={`/projects/${id}/export?videoId=${taskId}`} className="w-full">
                                    <button
                                ...
                                <button onClick={() => router.back()}
                                    ...
                                    style={{ background: "transparent", color: "#555", border: "3px solid #1e1e1e", boxShadow: "3px 3px 0 #000" }}>
                                    ← REGENERATE
                                </button>
                            </div>
                        </div>
